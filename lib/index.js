...
FileTransformCache.prototype.transformGlob = function transformGlob(globs, next) {
    if (typeof globs === 'string') {
        globs = [globs];
    }
    else if (!_.isArray(globs)) {
        return next( new Error('first parameter to transformGlob must be string or array'), null);
    }
