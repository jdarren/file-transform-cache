...
FileTransformCache.prototype._fileFromCacheEntry = function(cacheEntry) {
    var cachedFile = new File({path: cacheEntry.path, contents: new Buffer(cacheEntry.content)});
...
FileTransformCache.prototype._getTimestampImpl = function(file) {
    ...
    if ( cachedEntry.timestamp >= fileStats.mtime.getTime() ) {
        ...
        return this._fileFromCacheEntry(cachedEntry);
    }
    else {
